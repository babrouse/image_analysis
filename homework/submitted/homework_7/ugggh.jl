using Random, Plots, SpecialFunctions, Distributions, Optim
...
function sim_ps(N_camera, wavelength, NA, camera_scale, fine_scale, N_photon; center=(0, 0), B=0)
...
function calculate_MLE(intensities, initial_guess; camera_scale=0.01, origin_center=true)
    ...
    results = optimize(objective, Float64.(initial_guess))
